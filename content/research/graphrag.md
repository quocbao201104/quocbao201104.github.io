...
- What is OmniPilot?
- What is Marketing Practitioner and how is its runtime structured?
...
- Which projects encode evidence or epistemic boundaries into agent behavior?
- Which projects are public versus private?
- Which engineering patterns recur across product and research work?

## Proposed Entity Model
- Person: Quoc Bao.
- Project: OmniPilot, Marketing Practitioner, TruyenVietHay, Trustworthy Agentic Systems, MarketGap, BAO.OS.
- Public Artifact: CD1-2, Audio Ingest.
- Technology: TypeScript, Node.js, Fastify, Express, Vue, Next.js, Python, PostgreSQL, MySQL, Redis, Docker, R2, Cloudinary, Chrome MV3.
- Concept: durable state, idempotency, provenance, authorization, temporal correctness, retrieval, bounded effects, recovery, decision routing, evidence boundaries, scoped learning.

Example relationships: `OmniPilot USES durable local state`, `Marketing Practitioner ROUTES open decisions to addressable knowledge`, `Marketing Practitioner PRESERVES evidence and claim boundaries`, `TruyenVietHay DELIVERS media via CDN`, `MarketGap PRODUCES engine_sync_v3 read models`, `Trustworthy Agentic Systems STUDIES action-to-effect binding`, `BAO.OS IMPLEMENTS vector retrieval architecture`.

## Pitfalls
Do not present proposed graph nodes as implemented infrastructure. Do not turn technical relationships into employment, scale, novelty, causal effectiveness, or performance claims.
