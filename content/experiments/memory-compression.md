...
- Compress each current project into: status, aliases, summary, problem, architecture, data flow, stack, reliability/security or evidence-governance highlights, public evidence, private-source boundary, and honest non-claims.
...
## Current Result
The 2026-08-24 refresh covers the current five-project story:
- OmniPilot — building / active commercial / private source.
- Marketing Practitioner — building in public / active open-source research + implementation / public source.
- TruyenVietHay — shipped / completed / public source.
- Trustworthy Agentic Systems — research in progress / authoritative held-out results unseen.
- MarketGap — explored / paused / private source.

Supporting public engineering evidence is indexed separately through BAO.OS, CD1-2, and Audio Ingest.
